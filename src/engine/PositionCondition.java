...
public class PositionCondition extends Condition {
    ...
    @JsonCreator
    public PositionCondition (@JsonProperty("playersPositionX") int X, @JsonProperty("PlayersPositionY") int Y) {
        // TODO: needs to be passed in something that allows this condition to dynamically get player's x and y
        playersPositionX = X;
        playersPositionY = Y;
    }
