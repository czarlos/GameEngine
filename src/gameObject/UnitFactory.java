...
public class UnitFactory extends GameObject {
     ...
     * made has been met, this unit is put in the unitList of
     * the team that is responsible for creating said unit.
     * Units are placed at a valid tile adjacent to the factory.
     * If a unit is not being created the turn counter on that
     * unit is decremented. Should be called every turn.
     * 
     * @param team - The team associated with this factory
     */
     ...
     * make this unit.
     * 
     * @param unitName - The string name of the unit to be created
     */
    public void enqueueUnit (String unitName) {
        myPendingUnits.put(myPossibleUnits.get(unitName), myNumberOfTurns.get(unitName));
    }
}
