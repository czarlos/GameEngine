...
public class EditorFrame extends GameView {
	...
	private void newGame() {
		...
		if (value == JOptionPane.OK_OPTION) {
			...
			setFrame(wm);
			addStagePanel();
			stageTabbedPane.addChangeListener(new TabChangeListener(
	...
	private void addStagePanel() {
		...
		int value = JOptionPane.showConfirmDialog(this, stageInfoPanel,
				"Enter Stage Information", JOptionPane.OK_CANCEL_OPTION);
		if (value == JOptionPane.OK_OPTION) {
