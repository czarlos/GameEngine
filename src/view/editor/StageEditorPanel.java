...
public class StageEditorPanel extends JTabbedPane {
    ...
    public void changeSelected (GameObjectPanel selected) {
        ...
        myWorldManager.setActiveObject(this.getSelectedIndex(), selected.getType(), myWorldManager
                .get(selected.getType()).indexOf(selected.getName()));
    }
    ...
    private void createUnitEditor () {
        ...
        // JComponent newContentPane = new UnitEditorPanel((UnitTableModel)
        // myWorldManager.getViewModel("unit"));
    ...
    class EditListener implements ActionListener {
        ...
        public void actionPerformed (ActionEvent e) {
            ...
            switch (myType.toLowerCase()) {
                case "tile":
                    TileEditorDialog ted =
                            new TileEditorDialog(gtm,
                                                 new DialogListener(myWM, gtm, myPanel, myType));
                    ted.setVisible(true);
                    break;
                case "gameunit":
