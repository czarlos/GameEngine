...
public class TextPane extends JPanel
    ...
    public TextPane() {
        ...
        rightPane.setMinimumSize(new Dimension(100,100));
        ...
        leftPane.add(areaScrollPane,
                     BorderLayout.CENTER);
        leftPane.setMinimumSize(new Dimension(500,100));
    ...
    private JEditorPane createEditorPane() {
        ...
        java.net.URL helpURL = TextPane.class.getResource(
    ...
    protected static ImageIcon createImageIcon(String path,
                                               String description) {
        java.net.URL imgURL = TextPane.class.getResource(path);
        if (imgURL != null) {
